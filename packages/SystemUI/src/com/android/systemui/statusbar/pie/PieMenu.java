...
public class PieMenu extends RelativeLayout {
    ...
    private void getDimensions() {
        ...
        if (themeMode == 0) {
            ...
            mDarkThemeEnabled = primaryTheme != 0;
        } else {
        ...
        mBatteryMode = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                Settings.Secure.PIE_BATTERY_MODE, 1, UserHandle.USER_CURRENT);

        // status indicator
        mStatusIndicator = Settings.Secure.getIntForUser(mContext.getContentResolver(),
                Settings.Secure.PIE_STATUS_INDICATOR, 3, UserHandle.USER_CURRENT);
        ...
        mBackgroundCirclePaint.setColor(mDarkThemeEnabled ? mBackgroundCircleColor
                : mForegroundColor);
        mBatteryPaint.setColor(mBatteryLevel > 15 ? mBatteryColor : mBatteryLowColor);
    ...
    private void createSignalIcons() {
        ...
        mWifiIcon.setVisibility(mStatusIndicator == 0 || mStatusIndicator == 2
                ? View.GONE : View.VISIBLE);
        mNetworkIcon.setVisibility(mStatusIndicator == 0 || mStatusIndicator == 1
    ...
    private String getNetworkText() {
        ...
        return operatorName != null ? operatorName.toUpperCase() : null;
    }
    ...
    protected void onDraw(final Canvas canvas) {
        ...
        if (mBatteryMode == 2 || mBatteryMode == 3) {
            // Draw battery circle
